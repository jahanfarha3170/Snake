...
public class PanelGui extends JPanel implements ActionListener {
    ...
    final int x[] = new int[OBJECTS_COUNT]; // x co-ordinate
    final int y[] = new int[OBJECTS_COUNT]; // y co-ordinate
    int snakeBodyPart = 6;
    int appleEatCount;
    int appleGenerateXaxis;
    int appleGenerateYaxis;
    char direction = 'R'; // assuming snake start from right direction
